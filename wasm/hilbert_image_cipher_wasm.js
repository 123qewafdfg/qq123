/* @ts-self-types="./hilbert_image_cipher_wasm.d.ts" */

/**
 * @enum {0 | 1}
 */
export const CipherMethod = Object.freeze({
    Gilbert: 0, "0": "Gilbert",
    Block: 1, "1": "Block",
});
 ...
 * @enum {0 | 1}
 */
export const CipherMode = Object.freeze({
    Encrypt: 0, "0": "Encrypt",
    Decrypt: 1, "1": "Decrypt",
});
 ...
 * @param {number} width
 * @param {number} height
 * @param {CipherMethod} method
 * @param {CipherMode} mode
 * @param {string} key
 * @param {number} block_width
 * @param {number} block_height
 * @param {boolean} apply_xor
 * @returns {Uint8Array}
 */
 ...
 * @returns {number}
 */
export function xor_fixed_key() {
    const ret = wasm.xor_fixed_key();
    return ret;
}
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./hilbert_image_cipher_wasm_bg.js": import0,
    };
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('hilbert_image_cipher_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
